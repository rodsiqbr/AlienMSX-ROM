...
ALIENMSXSONGFILE_SUBSONG0_TRACK0: .db 0x63
    .db 0x73
    .db 0x3
    .db 0x63
    .db 0x43
...
ALIENMSXSONGFILE_SUBSONG0_TRACK2: .db 0xfe
    ...
    .db 0x4
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK3: .db 0x61
    .db 0x71
    .db 0x2
    .db 0x71
    .db 0x3
...
ALIENMSXSONGFILE_SUBSONG0_TRACK5: .db 0x71
    ...
    .db 0xc8
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK6: .db 0x61
    .db 0x71
    .db 0x2
    .db 0x71
    .db 0x3
...
ALIENMSXSONGFILE_SUBSONG0_TRACK7: .db 0x76
    ...
    .db 0xc0
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK8: .db 0xb0
    .db 0x0
    .db 0x62
    .db 0x72
    .db 0x2
    ...
    .db 0x0
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK9: .db 0xb2
    .db 0x5
    .db 0x8e
    .db 0x44
    .db 0x82
    ...
    .db 0x0
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK10: .db 0xbe
    .db 0x44
    .db 0x5
    .db 0x8e
    .db 0x46
...
ALIENMSXSONGFILE_SUBSONG0_TRACK12: .db 0xcf
    ...
    .db 0x0
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK13: .db 0x87
    .db 0xc3
    .db 0x1
    .db 0x87
    .db 0x7
    .db 0xc3
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK14: .db 0x87
    .db 0x83
    .db 0x87
    .db 0xc3
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK15: .db 0x8e
    .db 0x22
    .db 0x8e
    .db 0x2e
    .db 0x83
...
PLY_AKM_TRACK2_ESCAPEINSTRUMENT = 0xc083
PLY_AKM_TRACK2_ESCAPENOTE = 0xc082
PLY_AKM_TRACK2_ESCAPEWAIT = 0xc084
PLY_AKM_TRACK2_PTINSTRUMENT = 0xc085
PLY_AKM_TRACK2_REGISTERS = 0xc029
PLY_AKM_TRACK2_VOLUME = 0xc02a
PLY_AKM_TRACK2_WAITEMPTYCELL = 0xc07b
PLY_AKM_TRACK3_ESCAPEINSTRUMENT = 0xc092
PLY_AKM_TRACK3_ESCAPENOTE = 0xc091
PLY_AKM_TRACK3_ESCAPEWAIT = 0xc093
PLY_AKM_TRACK3_PTINSTRUMENT = 0xc094
PLY_AKM_TRACK3_REGISTERS = 0xc035
PLY_AKM_TRACK3_VOLUME = 0xc036
PLY_AKM_TRACK3_WAITEMPTYCELL = 0xc08a
