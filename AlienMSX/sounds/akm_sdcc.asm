...
ALIENMSXSONGFILE_SUBSONG0_TRACK11: .db 0xc2
    ...
    .db 0xc0
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK12: .db 0xce
    .db 0x46
    .db 0x7
    .db 0xf8
    .db 0x5
...
ALIENMSXSONGFILE_SUBSONG0_TRACK14: .db 0xc7
    ...
    .db 0xc3
    .db 0x7f
ALIENMSXSONGFILE_SUBSONG0_TRACK15: .db 0xcf
    .db 0x3
    .db 0xe
    .db 0x2e
    .db 0x3
...
ALIENMSXSONGFILE_SUBSONG4_TRACKINDEXES: .dw ALIENMSXSONGFILE_SUBSONG4_TRACK1
    .dw ALIENMSXSONGFILE_SUBSONG4_TRACK0
